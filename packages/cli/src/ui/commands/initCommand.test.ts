...
describe('initCommand', () => {
  ...
  const geminiMdPath = path.join(targetDir, 'SEGA.md');
  ...
  it('should inform the user if SEGA.md already exists', async () => {
  ...
  it('should create SEGA.md and submit a prompt if it does not exist', async () => {
    ...
    expect(mockContext.ui.addItem).toHaveBeenCalledWith(
      {
        type: 'info',
        text: 'Empty SEGA.md created. Now analyzing the project to populate it.',
      },
      expect.any(Number),
    );
