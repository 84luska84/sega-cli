...
export const INFORMATIVE_TIPS = [
  ...
  'Show SEGA-CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific SEGA.md file with /init',
  ...
  'Reload instructional context from SEGA.md files with /memory reload',
